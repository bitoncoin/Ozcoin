...
if(isSet($_COOKIE[$cookieName])){
	...
	$userInfoQ = mysql_query("SELECT id, username, email, pin, pass, admin, api_key, share_count, stale_share_count, shares_this_round, hashrate, donoragree, donorend, donorselect, sendemail, recivemail, deadworker, ipcheck, nickname, IFNULL(donate_percent, '0') as donate_percent FROM webUsers WHERE id = $userId LIMIT 0,1") or sqlerr(__FILE__, __LINE__); 	
