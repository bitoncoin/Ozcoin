...
else
{
	...
	echo "<tr><th scope=\"col\" colspan=\"2\">Total LTC Earned</th></tr><tr class=\"moneyheader\"><td class=\"bitcoin_image\"><img class=\"earned_coin\" src=\"/images/bitcoin.png\" /></td><td class=\"bitcoins\">";

//	$result = mysql_query_cache("SELECT paid + balance as amount_earned  FROM accountBalance WHERE userid = $userInfo->id");
	$result = mysql_query_cache("SELECT sum(amount) as amount_earned  FROM rounddetails WHERE rewarded = 'Y' and userid = $userInfo->id");
